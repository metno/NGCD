...
# 2. stations in CG
stations<-getStationMetadata_NGCD(from.year=yyyy,to.year=yyyy,path=main.path.output,
...
r[]<-NA
# get data 
data<-getStationData_NGCD(var="TEMP1d", yyyy=yyyy, mm=mm, dd=dd, statlist=stations,path=main.path.output)
