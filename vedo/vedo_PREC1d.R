...
fileborders<-paste(main.path.geoinfo,"/TM_WORLD_BORDERS_ETRS89_ETRS-LAEA/TM_WORLD_BORDERS_ETRS89_ETRS-LAEA-0.2.shp",sep="")
...
path2input.1d.main<-paste(main.path.output,"/NGCD/PREC1d",sep="")
...
path2input.1d.add<-paste(main.path.output,"/NGCD_addInfo/PREC1d",sep="")
...
in.1d.file.grd.idi<- paste(path2input.1d.add.grd,"/",yyyymm,
                           ...
                           yyyymmdd,"_",yyyymmdd,".nc",sep="")
# output directories
dir.create(file.path(main.path.output,"NGCD_scratch"), showWarnings = FALSE)
path2output.main<-paste(main.path.output,"/NGCD_scratch/PREC1d",sep="")
path2output.main.grd<-paste(path2output.main,"/PREC",sep="")
path2output.add<-paste(main.path.output,"/NGCD_scratch/PREC1d",sep="")
...
aux<-att.get.ncdf(nc,"Lambert_Azimuthal_Equal_Area","projection")
projstr<-aux$value
